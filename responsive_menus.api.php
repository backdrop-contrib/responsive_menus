 ...
 * form            :string:  Backdrop FAPI callback for admin form.
...
function hook_responsive_menus_style_info() {
  $path = backdrop_get_path('module', 'responsive_menus');
  $styles = array(
    'example_style' => array(
...
function example_style_settings() {
  $form['responsive_menus_css_selectors'] = array(
    ...
    '#default_value' => config_get('responsive_menus.settings', 'responsive_menus_css_selectors'),
  ...
  $form['responsive_menus_simple_text'] = array(
    ...
    '#default_value' => config_get('responsive_menus.settings', 'responsive_menus_simple_text'),
  );
  $form['responsive_menus_media_size'] = array(
    '#type' => 'textfield',
    '#title' => t('Screen width to respond to'),
    '#size' => 10,
    '#default_value' => config_get('responsive_menus.settings', 'responsive_menus_media_size'),
...
function example_style_js_settings() {
  $js_settings = array();
  $js_settings['selectors'] = config_get('responsive_menus.settings', 'responsive_menus_css_selectors');
  $js_settings['toggler_text'] = config_get('responsive_menus.settings', 'responsive_menus_simple_text');
  $js_settings['media_size'] = config_get('responsive_menus.settings', 'responsive_menus_media_size');
